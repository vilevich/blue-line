    ...
    >
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-[12px] text-[var(--text-subtle)] hover:text-[var(--text-strong)] px-3 py-1.5 rounded-md transition-colors flex items-center gap-2"
        >
    ...
    <nav className="docs-sidebar fixed top-[var(--ds-header-h)] left-0 bottom-0 w-[var(--ds-sidebar-w)] overflow-y-auto overflow-x-hidden bg-[var(--surface-bg)] py-4">
      <div className="px-3 pb-4">
        <input
          ...
          className="w-full h-8 px-3 text-[12px] border border-[var(--border-200)] rounded-md bg-[var(--surface-card)] text-[var(--text-strong)] outline-none placeholder:text-[var(--text-muted)] focus:border-[var(--color-neutral-500)] transition-colors"
      ...
      {NAV.map((group) => {
        ...
        return (
          <div key={group.title} className="mb-1">
            <h4 className="text-[12px] font-medium text-[var(--text-strong)] px-4 pt-2 pb-1">
              {group.title}
            </h4>
            {visible.map((item) => (
              <button
                ...
                className={cn(
                  'block w-full text-left px-4 py-1.5 text-[12px] transition-colors cursor-pointer border-none bg-transparent',
                  activePage === item.id
